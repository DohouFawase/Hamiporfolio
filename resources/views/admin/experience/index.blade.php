                        ...
                        <tr>
                            <td>
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="fw-semibold fs-16 mb-0 lh-base hover">{{Str::limit($item->description,40, '...')}}
                                    </h4>
                                </div>
                        </td>
                        <td>
                            <span class="d-block fs-15 text-center">{{$item->post}}</span>
                           
                        </td>
                        <td>
                            <span class="d-block fs-15 text-center">{{$item->entreprise}}</span>
                        </td>
                        <td>
                            <span
                                class="badge bg-success bg-opacity-10 text-success py-2 px-3 fw-semibold d-block text-center">{{$item->periode}}</span>
                        </td>
